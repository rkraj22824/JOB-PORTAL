...
const JobDescription = () => {
  return (
    ...
    <div className='my-4'>
        ...
        <h1 className='font-bold my-1'>Total Applicants: <span className='pl-4 font-normal text-gray-800'>{length}</span></h1>
        <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>{createdAt}</span></h1>
    </div>
</div>
  )
}
